...
export const MISES_DISPLAY_NAME = 'Mises Network';
...
export const MISES_RPC_URL = 'http://127.0.0.1:26657';
...
export const MISES_TOKEN_IMAGE_URL = './images/mises-token.jpg';
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [NETWORK_TYPES.MISES]: MISES_DISPLAY_NAME,
...
export const CHAIN_ID_TO_TYPE_MAP = {
  ...
  [CHAIN_IDS.MISES]: NETWORK_TYPES.MISES,
} as const;
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [CHAIN_IDS.MISES]: MISES_TOKEN_IMAGE_URL,
} as const;
...
export const NETWORK_ID_TO_ETHERS_NETWORK_NAME_MAP = {
  ...
  [NETWORK_IDS.MISES]: NETWORK_TYPES.MISES,
} as const;
...
export const CHAIN_ID_TO_NETWORK_ID_MAP = {
  ...
  [CHAIN_IDS.MISES]: NETWORK_IDS.MISES,
} as const;
...
export const NATIVE_CURRENCY_TOKEN_IMAGE_MAP = {
  ...
  [CURRENCY_SYMBOLS.MISES]: MISES_TOKEN_IMAGE_URL,
} as const;
